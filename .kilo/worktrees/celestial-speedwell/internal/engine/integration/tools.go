// Package integration provides enhanced export and integration capabilities
// for connecting BBPTS with professional security tools like Burp Suite, Caido, OWASP ZAP, and others.
package integration
