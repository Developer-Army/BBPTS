// Package fingerprint implements TLS JARM fingerprinting and Favicon hash clustering
// to discover infrastructure-linked targets that share the same server stack but
// are not connected by DNS records.
package fingerprint
