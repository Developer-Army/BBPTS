...
### `internal/ui/report/`
- **enhanced_report.go**: Comprehensive report generation
...
```go
func ExportToNewFormat(filename string, report *EnhancedReport) error {
    // Format conversion
...
File: `internal/ui/report/enhanced_report.go`

```go
func (rg *ReportGenerator) exportForNewTool(report *EnhancedReport) error {
