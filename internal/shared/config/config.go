...
func (c *Config) LoadFromEnv() {
	envKeys := map[string]string{
		...
		"BBPTS_CENSYS_API_KEY":         "censys_id",
		"BBPTS_CENSYS_SECRET":          "censys_secret",
		...
		"BBPTS_PASSIVETOTAL_EMAIL":     "passivetotal_email",
		"BBPTS_BINARYEDGE_API_KEY":     "binaryedge",
		"BBPTS_FULLHUNT_API_KEY":       "fullhunt",
		"BBPTS_NETLAS_API_KEY":         "netlas",
		"BBPTS_WHOISXML_API_KEY":       "whoisxmlapi",
		"BBPTS_INTELX_API_KEY":         "intelx",
		"BBPTS_FOFA_EMAIL":             "fofa_email",
		"BBPTS_FOFA_KEY":               "fofa_key",
		"BBPTS_ZOOMEYE_API_KEY":        "zoomeye",
		"BBPTS_QUAKE_API_KEY":          "quake",
		"BBPTS_BEVIGIL_API_KEY":        "bevigil",
		"BBPTS_ROBTEX_API_KEY":         "robtex",
		"BBPTS_CERTSPOTTER_API_KEY":    "certspotter",
		"BBPTS_C99_API_KEY":            "c99",
		"BBPTS_CHINAZ_API_KEY":         "chinaz",
		"BBPTS_THREATBOOK_API_KEY":     "threatbook",
		"BBPTS_DNSDB_API_KEY":          "dnsdb",
		"BBPTS_REDHUNTLABS_API_KEY":    "redhuntlabs",
		"BBPTS_FACEBOOK_APP_ID":        "facebook",
		"BBPTS_FACEBOOK_APP_SECRET":    "facebook_secret",
		"BBPTS_HUNTER_API_KEY":         "hunter",
