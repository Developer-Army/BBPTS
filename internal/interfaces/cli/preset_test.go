...
func TestApplyPresetAndProfileDefaults_LightModeFiltersExplicitTools(t *testing.T) {
	...
	want := "crtsh,subfinder,amass,assetfinder,chaos,puredns,dnsx,massdns,whois,naabu,httpx,shodan,katana,gau,hakrawler,uro,dalfox,nuclei,interactsh,secrets,trufflehog,browser,js_analyzer,gowitness,tlsx,github,cloud_buckets,takeover,graphql,oauth,proto_pollution,websocket,smuggling,race,cache_poisoning,ai_vuln,idor_assist,github_dorker,github_actions,github_org_discovery,mobile_static,app_store_recon,cors,jwt_analyzer,bypass403,firebase_recon,mass_assignment,source_map,default_creds,asn_recon,cve_correlate,grpc_probe,git_exposure,web3_recon,paste_leaks,cert_monitor,price_logic,dep_audit,soap_probe,mobile_recon,cloud_exposure,blind_inject,business_logic,second_order,redos,supply_chain,tenant_isolate,auth_matrix,ratelimit_bypass,wordlist_gen"
	if opts.Tools != want {
