...
func formatDiffMessage(scope string, diff *utils.Diff) string {
...
func formatRuleMatchMessage(scope string, matches []recon.Match) string {
	var b strings.Builder
...
func filterByPriority(matches []recon.Match, priorities ...string) []recon.Match {
	set := make(map[string]struct{})
	for _, p := range priorities {
		set[p] = struct{}{}
	}
	var filtered []recon.Match
