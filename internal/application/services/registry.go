...
var toolFactories = map[string]struct {
	...
	"mobile_static":         {factory: func() Tool { return &MobileStaticTool{} }, stage: 1},
	"mobile_dynamic":        {factory: func() Tool { return &MobileDynamicTool{} }, stage: 4},
	"mobile_api_discovery":  {factory: func() Tool { return &MobileAPIDiscoveryTool{} }, stage: 3},
	"app_store_recon":       {factory: func() Tool { return &AppStoreReconTool{} }, stage: 0},
	"github_actions":        {factory: func() Tool { return &GithubActionsTool{} }, stage: 0},
	"github_vuln_scanning":  {factory: func() Tool { return &GithubVulnScanningTool{} }, stage: 1},
	"github_org_discovery":  {factory: func() Tool { return &GithubOrgDiscoveryTool{} }, stage: 0},
	"github_private_repos":  {factory: func() Tool { return &GithubPrivateReposTool{} }, stage: 0},
}
