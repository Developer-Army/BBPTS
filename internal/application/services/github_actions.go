...
func (t *GithubActionsTool) Run(ctx context.Context, targets []string, threads int) ([]Event, error) {
...
func (t *GithubActionsTool) analyze(ctx context.Context, apiKey, orgOrRepo string) ([]Event, error) {
	events := []Event{}
...
func (t *GithubActionsTool) analyzeRepo(ctx context.Context, apiKey, repo string) ([]Event, error) {
	events := []Event{}
...
func (t *GithubActionsTool) analyzeWorkflow(content, repo, name, path string) []Event {
	events := []Event{}
