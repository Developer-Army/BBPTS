...
func (t *GithubPrivateReposTool) Run(ctx context.Context, targets []string, threads int) ([]Event, error) {
...
func (t *GithubPrivateReposTool) scan(ctx context.Context, apiKey, orgOrRepo string) ([]Event, error) {
	events := []Event{}
...
func (t *GithubPrivateReposTool) scanRepo(ctx context.Context, apiKey, repo string) []Event {
	events := []Event{}
...
func (t *GithubPrivateReposTool) analyzeContent(repo, filePath, content string) []Event {
	events := []Event{}
...
func (t *GithubPrivateReposTool) scanTree(ctx context.Context, apiKey, repo string) []Event {
	events := []Event{}
